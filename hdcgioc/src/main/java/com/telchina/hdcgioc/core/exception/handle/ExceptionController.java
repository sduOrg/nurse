package com.telchina.hdcgioc.core.exception.handle;

import com.telchina.hdcgioc.core.ApplicationConfig;
import com.telchina.hdcgioc.core.RestResponse;
import com.telchina.hdcgioc.core.exception.AuthException;
import com.telchina.hdcgioc.core.exception.ErrorResult;
import com.telchina.hdcgioc.core.exception.PermissionException;
import com.telchina.hdcgioc.core.exception.alert.IExceptionAlert;
    ...
    private RestResponse<String> getRestResponse(HttpServletRequest request, HttpStatus status, Map<String, Object> body) { // NOSONAR
        ...
        if (status == HttpStatus.NOT_FOUND) { // 404处理
            ...
            if (object instanceof Exception) { // 上下文中能拿到异常的情况
                ...
                // ZuulException异常特殊处理,去除ZuulException的包裹
                // (不用instanceof的原因是不想因为这里的判断而引入zuul的依赖在core包中)
